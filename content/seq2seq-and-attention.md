...
| [Self-Attention](/learn/e-shikaku/self-attention/) | 系列内の要素同士を参照する注意の枠組みです。ここで扱う加法注意はRNNのエンコーダ・デコーダに組み込まれています |
| [Transformer](/learn/e-shikaku/transformer/) | 再帰を使わず注意を中心に構成する別モデルです。「注意を使う」だけで加法注意と同一視しません |
