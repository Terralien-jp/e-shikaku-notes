...
| 用語 | 切り分け |
|---|---|
| [MSE](/learn/e-shikaku/mse-and-mae/) | 外れ値を強く反映し、条件付き平均を推定する損失 |
| [MAE](/learn/e-shikaku/mse-and-mae/) | 外れ値に頑健で、条件付き中央値を推定する損失 |
| Huber／Smooth L1 | 残差の小さい領域を二乗、大きい領域をL1にする損失 |
| [評価指標](/learn/e-shikaku/regression-metrics/) | 学習で勾配を作る損失とは目的が異なる。値の比較方法は別途設計する |
