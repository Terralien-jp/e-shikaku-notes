...
| [適合率・再現率](/learn/e-shikaku/precision-recall-f1/) | FPを抑えるかFNを抑えるかという、異なる業務上の優先度を表す |
| [F1](/learn/e-shikaku/precision-recall-f1/) | 適合率と再現率を一つにまとめる。誤りの金額を直接表す指標ではない |
| [macro・weighted・micro](/learn/e-shikaku/multiclass-averaging/) | 多クラスの集計方法の違い。指標そのものの定義とは別の選択 |
